...
('Sheru', 2, 'Labrador', 'Dog', 1),
('Mithu', 3, 'Siamese', 'Cat', 1),
('Chintu', 1, 'Beagle', 'Dog', 1),
('Rani', 4, 'Persian', 'Cat', 0),
('Rocky', 5, 'Bulldog', 'Dog', 1),
('Golu', 6, 'Golden Retriever', 'Dog', 0),
('Chikki', 2, 'Poodle', 'Dog', 1),
('Simba', 3, 'Maine Coon', 'Cat', 1),
('Moti', 1, 'Doberman', 'Dog', 1),
('Shera', 4, 'German Shepherd', 'Dog', 0);

GO

-- Insert Data into Donations
INSERT INTO Donations (DonationID, DonorName, DonationType, DonationAmount, DonationItem) VALUES
